...
class The_model extends CI_Model {
        ...
        public function insert_entry()
        {
                ...
                $sql = "INSERT INTO `data_mahasiswa` VALUES ('NULL', '$data[nama]', '$data[nim]', '$data[jenis_kelamin]', '$data[tempat_lahir]','$data[tanggal]' , '$data[alamat]', '$data[golongan_darah]', '$data[prodi]', '$data[angkatan]')";
